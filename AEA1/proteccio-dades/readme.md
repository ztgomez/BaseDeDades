# Legislació protecció de dades

## Introduccció

En aquest apartat aprendrem de legislació sobre protecció de dades.

## Context

Els drets digitals dels ciutadans ja venen recolliys a l'article 18 de la constitució:
...
La legislació de protecció de dades a Espanya està principalment regida per dues normes fonamentals: el Reglament General de Protecció de Dades (RGPD) de la Unió Europea i la Llei Orgànica de Protecció de Dades Personals i Garantia dels Drets Digitals (LOPDPGDD).
